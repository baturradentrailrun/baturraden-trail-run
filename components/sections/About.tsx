    ...
    >
      <div className="py-10 padding-container w-full  ">
        ...
        <p className="md:w-10/12 mb-10 ">
          ...
          tersinkronisasi dengan aplikasi Yoayo. Dan Offline Race di mana
          Peserta berlari secara bersamaan di Kawasan Baturraden, Kab. Banyumas.
          Baturraden Trail Run menjadi kesempatan yang sempurna bagi pelari dari
          semua tingkatan untuk merasakan tantangan. Mari berlari menyusuri
